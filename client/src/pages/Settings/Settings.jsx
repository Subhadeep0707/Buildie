  ...
  return (
    <div className="h-full w-full overflow-y-auto bg-gray-100 dark:bg-[#12141c] p-6 md:p-10">
      <div className="max-w-3xl space-y-6">
        ...
        {/* Material Rates */}
        <div className="bg-white dark:bg-[#232734] p-5 rounded shadow border border-gray-200 dark:border-gray-800 pb-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <input
              ...
              className="border p-3 rounded bg-gray-50 dark:bg-[#1a1d27] dark:text-white dark:border-gray-700"
            />
            <input
              type="number"
              name="steelPerKg"
